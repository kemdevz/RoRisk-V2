...
function RaceTimer() {
  ...
  return <div className="race-timer is-compact" {...timerScope}><div className="timer-compact" {...timerScope}>{text.split('').map((value, index) => value === ':' ? <div className="compact-colon" key={`colon-${index}`} {...timerScope}>:</div> : <div className="compact-digit" key={`digit-${index}`} {...timerScope}><div className="flip-number" key={value} {...timerScope}>{value}</div></div>)}</div></div>
}

function RaceAvatar() {
  return <div className="avatar-image" data-v-6adb23f8="" {...podiumScope}><img src="/default-avatar.png" alt="" data-v-6adb23f8="" {...podiumScope} /></div>
}

function RacePlacementRow({ place }) {
  return <div className="leaderboard-user-element" {...rowScope}><div className="element-inner" {...rowScope}><div className="inner-pos" {...rowScope}>{place}</div><div className="inner-user user-hidden" {...rowScope}><div className="user-avatar" {...rowScope}><div className="avatar-image" data-v-6adb23f8="" {...rowScope}><img src="/default-avatar.png" alt="" data-v-6adb23f8="" {...rowScope} /></div></div><span className="user-username" {...rowScope}>--</span></div><div className="inner-wagered" {...rowScope}><div className="wagered-content" {...rowScope}><img src="/Race/points.6eb375c8.svg" alt="" {...rowScope} /><div className="content-value" {...rowScope}><span {...rowScope}>0</span></div></div></div><div className="inner-prize" {...rowScope}><div className="prize-content" {...rowScope}><img src="/Race/prize-coin.4c029a97.svg" alt="" {...rowScope} /><div className="content-value" {...rowScope}><span {...rowScope}>0</span></div></div></div></div></div>
}
